  ...
  $my_meta_box = array(
    ...
    'fields'    => array(     
     ...
     array(
        ...
        'class'       => '',
        'choices'     => array(),
        'condition'   => 'form_display:is(on),form_field_settings:is(on),form_type:is(vertical)',
        'operator'    => 'and'
      ),
     array(
        ...
        'class'       => '',
        'choices'     => array(),
        'condition'   => 'form_display:is(on),form_field_settings:is(on)',
        'operator'    => 'and'
      ),
     array(
