...
add_action('delete_attachment', 'landx_delete_resized_images');
...
function landx_image_resize($url, $width=null, $height=null, $crop=true, $align='c', $retina=false) {
  ...
  $common = landx_common_info($url, $width, $height, $crop, $align, $retina);
...
function landx_common_info($url, $width, $height, $crop, $align, $retina) {
...
function landx_delete_resized_images($post_id) {
