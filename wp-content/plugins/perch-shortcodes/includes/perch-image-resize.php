...
function perch_image_resize($url, $width=null, $height=null, $crop=true, $align='c', $retina=false) {

  global $wpdb;

  // Get common vars (func_get_args() only get specified values)
  $common = perch_common_info($url, $width, $height, $crop, $align, $retina);
...
function perch_common_info($url, $width, $height, $crop, $align, $retina) {
